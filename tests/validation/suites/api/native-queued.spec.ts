// tests/validation/suites/api/native-queued.spec.ts
//
// Validates the native sandbox + queued execution mode matrix.
...
const definitions = getDefinitionsByCategory("native-queued");
